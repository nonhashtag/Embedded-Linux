...
#define IOM_FPGA_STEP_MOTOR_MAJOR 267 // ioboard led device majornumber
#define IOM_FPGA_STEP_MOTOR_NAME "fpga_step_motor" // ioboard led devicename
...
// define functions...
ssize_t iom_fpga_step_motor_write(struct file *inode, const char *gdata, size_t length, loff_t
*off_what);
